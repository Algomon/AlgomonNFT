function init() {
    ...
    let bannerContent = "Shiny Antares#drops Sep 19 on Rand Gallery"+
    "#Price decreases every day until sold"+"#1 minted - once gone, it's gone"
    const banners = []
    let spriteId = 0
    let topIndex = 3
    let count = 0
    ...
    const createPlane = sentence =>{
      ...
      plane.style.top = `${topValues[topIndex] * (plane.offsetHeight-30) + (20 * topValues[topIndex])}px`
